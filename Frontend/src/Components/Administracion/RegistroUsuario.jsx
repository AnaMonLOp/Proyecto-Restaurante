            ...
            <div className="registro-card">
                ...
                <form onSubmit={onSubmit} noValidate>
                    <div className="registro-form-grid">
                        ...
                        <div className="registro-field">
                            <label className="registro-label" htmlFor="rol">Rol</label>
                            <select
                                id="rol"
                            ...
                            {touched.rol && errores.rol && (
                                <span className="registro-error-text">{errores.rol}</span>
                            )}
                        </div>
                        ...
                        {exito && (
                            <div className="registro-success-box">Usuario registrado correctamente</div>
                        )}
